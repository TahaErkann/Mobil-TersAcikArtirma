...
const HomeScreen: React.FC<HomeScreenProps> = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    // Kategori güncellendiğinde ilanları yeniden yükle
    const handleCategoryUpdated = (data: any) => {
      console.log('Kategori güncellendi (HomeScreen):', data);
      fetchData();
    };
              ...
              >
                <Card style={[
                  ...
                  typeof listing.owner === 'object' 
                    ? (listing.owner._id === user?._id ? { backgroundColor: '#FFF9C4' } : {})
                    : (listing.owner === user?._id ? { backgroundColor: '#FFF9C4' } : {})
                ]}>
                  <ImageBackground
                    source={{ uri: getCategoryImage(listing.category) }}
